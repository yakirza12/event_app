...
class Photographer extends Business {
  ...
  */
  ...
  /* Photographer({this.descreption,this.name,this.place,this.area,this.rate,this.documentId,this.imageFileName,this.imageUrl,this.phone_number,this.reference,this.video,this.photographic_still
